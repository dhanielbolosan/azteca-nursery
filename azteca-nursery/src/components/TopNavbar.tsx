...
const TopNavbar: React.FC = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            // Show solid navbar after scrolling past homepage
        ...
        <Navbar expand="lg" fixed="top" className={`custom-navbar ${solidNavbar ? 'navbar-solid' : 'navbar-transparent'}`}>
            <Container className="position-relative">
                <Navbar.Brand href="/" className="position-absolute start-50 translate-middle-x">
                    {solidNavbar && (
                        <span style={{ fontFamily: 'American Brewery Rough', color: '#F4E6CD', fontSize: '1.5rem' }}>
                            Azteca Nursery
                        </span>
                    )}
                </Navbar.Brand>
    ...
    <path d="M3 6h18M3 12h18M3 18h18" stroke="#F4E6CD" strokeWidth="2" strokeLinecap="round" />
                ...
                data-bs-theme="dark">
                    <Offcanvas.Header closeButton>
                        <Offcanvas.Title id="offcanvasNavbarLabel-expand-lg" as="a" href="/">
                            Azteca Nursery
                        </Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body>
